...
export function NexoView({ user, userProfileData, showToast, mangas, onNavigate, onLevelUp, synthesizeCrystal, shopItems }) {
    ...
    const fetchRanking = async () => {
        ...
        try {
            ...
            let rankData = [];
            snap.forEach(doc => {
                if(doc.ref.path.includes('main') && (doc.data().level || doc.data().name || doc.data().displayName)) { 
    ...
    return (
        <div className={`pb-24 animate-in fade-in duration-500 relative font-sans min-h-screen text-gray-200 ${equipped.tema_perfil ? equipped.tema_perfil.cssClass : 'bg-[#010308]'}`}>
            ...
            <div className="max-w-6xl mx-auto px-4 py-8 relative z-10">
                ...
                {/* ABA FORJA / REATOR NEXO (IDÊNTICO À IMAGEM) */}
                {activeTab === "Forja" && (
                    ...
                    <div className="animate-in fade-in duration-300 max-w-4xl mx-auto pb-10">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="bg-[#05050a] border border-white/5 rounded-2xl p-8 flex flex-col items-center justify-center relative overflow-hidden shadow-lg group hover:border-cyan-500/50 transition-colors">
                                <img src={CHEST_CLOSED} className="w-28 h-28 mb-6 relative z-10 group-hover:scale-110 transition-transform duration-500 drop-shadow-[0_0_20px_rgba(6,182,212,0.4)] flex-shrink-0" alt="Chest" />
                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                <div className="bg-[#05050a] border border-white/5 rounded-2xl p-6 flex flex-col justify-center relative overflow-hidden shadow-lg flex-1">
                                    ...
                                    <p className="text-xs text-gray-400 font-medium mb-4 leading-relaxed">Converta 1000 XP em uma Caixa Nexo.</p>
