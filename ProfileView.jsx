          ...
          <div>
            ...
            {activeTab === "Biblioteca" && (
                <div className="animate-in fade-in duration-300">
                    {libraryMangas.length === 0 ? (
                        <div className="text-center py-12 bg-[#13151f] rounded-2xl border border-blue-900/20 shadow-inner"><Library className="w-10 h-10 mx-auto text-blue-900/40 mb-3"/><p className="text-blue-800/60 font-black text-[10px] uppercase tracking-widest">Sua coleção abissal está vazia.</p></div>
                    ) : (
            ...
            {activeTab === "Configuracoes" && (
                <div className="animate-in fade-in duration-300 space-y-6">
                    <div className="bg-[#13151f] border border-blue-900/20 p-5 rounded-2xl shadow-inner mt-4">
                    ...
                    <div className="bg-[#13151f] border border-blue-900/20 p-5 rounded-2xl shadow-inner">
